(deftheme tuntu "A dark theme.")

(let ((tuntu/green "#6aaf50")
      (tuntu/dark-green "#057f40")
      (tuntu/blue "#5180b3")
      (tuntu/light-blue "#528fd1")
      (tuntu/lighter-blue "#68a5e9")
      (tuntu/orange "#FF8512")
      (tuntu/tan "#bdbc61")
      (tuntu/dark-tan "#7d7c61")
      (tuntu/yellow "#baba36")
      (tuntu/bright-yellow "#fffe0a")
      (tuntu/purple "#9b55c3")
      (tuntu/gray "#656565")
      (tuntu/dark-gray "#555555")
      (tuntu/darker-gray "#454545")
      (tuntu/darkest-gray "#252525")
      (tuntu/red "#cd5542")
      (tuntu/dark-red "#9d2512")
      ...
      (tuntu/mode-line-active-fg "#252525")
      (tuntu/mode-line-active-bg "#7b7868")
      (tuntu/mode-line-inactive-fg "#7b7868")
      (tuntu/mode-line-inactive-bg "#252525"))

  ;; Set faces
  (custom-theme-set-faces
   `tuntu
   `(default ((t (:foreground ,tuntu/fg :background ,tuntu/bg))))
   `(cursor ((t (:foreground ,tuntu/bg :background ,tuntu/cursor))))
   `(fringe ((t (:background ,tuntu/fringe))))
   `(region ((t (:background ,tuntu/region))))

   `(font-lock-builtin-face           ((t (:foreground ,tuntu/light-blue))))
   `(font-lock-comment-face           ((t (:foreground ,tuntu/gray))))
   `(font-lock-comment-delimiter-face ((t (:foreground ,tuntu/dark-gray))))
   `(font-lock-function-name-face     ((t (:foreground ,tuntu/green))))
   `(font-lock-keyword-face           ((t (:foreground ,tuntu/blue))))
   `(font-lock-string-face            ((t (:foreground ,tuntu/tan))))
   `(font-lock-preprocessor-face      ((t (:foreground ,tuntu/orange))))
   `(font-lock-type-face              ((t (:foreground ,tuntu/red))))
   `(font-lock-constant-face          ((t (:foreground ,tuntu/purple))))
   `(font-lock-warning-face           ((t (:foreground "red" :bold t))))
   `(font-lock-variable-name-face     ((t (:foreground ,tuntu/yellow))))
   `(font-lock-doc-face               ((t (:foreground ,tuntu/dark-tan))))

   `(mode-line-inactive ((t (:foreground ,tuntu/mode-line-inactive-fg :background ,tuntu/mode-line-inactive-bg :box (:line-width 4 :color ,tuntu/mode-line-inactive-bg :style nil)))))
   `(mode-line          ((t (:foreground ,tuntu/mode-line-active-fg :background ,tuntu/mode-line-active-bg :box (:line-width 4 :color ,tuntu/mode-line-active-bg :style nil)))))

   `(linum ((t (:background ,tuntu/bg :foreground ,tuntu/gray))))

   `(popup-tip-face ((t (:background ,tuntu/fg :foreground ,tuntu/bg))))

   `(header-line ((t (:background ,tuntu/fg :foreground ,tuntu/bg))))

   `(button ((t (:foreground ,tuntu/lighter-blue :background nil :underline t))))

   `(isearch        ((t (:background ,tuntu/blue :foreground ,tuntu/bg))))
   `(lazy-highlight ((t (:background ,tuntu/bg :foreground ,tuntu/purple :underline t))))

   `(ace-jump-face-background ((t (:inherit font-lock-comment-face))))
   `(ace-jump-face-foreground ((t (:foreground ,tuntu/orange))))

   `(vertical-border ((t (:background ,tuntu/darker-gray :foreground ,tuntu/darkest-gray))))

   `(hl-line ((t (:background "#1f1f1f"))))

   `(highlight-indentation-face ((t (:background ,tuntu/darkest-gray))))

   `(minibuffer-prompt ((t (:foreground ,tuntu/bright-yellow :bold t :background nil))))

   `(compilation-error   ((t (:foreground ,tuntu/red :bold t))))
   `(compilation-warning ((t (:foreground ,tuntu/orange :bold t))))
   `(compilation-info    ((t (:foreground ,tuntu/green :bold t))))

   `(eshell-prompt        ((t (:foreground ,tuntu/purple))))
   `(eshell-ls-directory  ((t (:foreground ,tuntu/blue))))
   `(eshell-ls-product    ((t (:foreground ,tuntu/orange))))
   `(eshell-ls-backup     ((t (:foreground ,tuntu/darker-gray))))
   `(eshell-ls-executable ((t (:foreground ,tuntu/green))))

   `(comint-highlight-prompt ((t (:foreground ,tuntu/green))))

   `(erc-nick-default-face ((t (:foreground ,tuntu/blue))))
   `(erc-my-nick-face      ((t (:foreground ,tuntu/yellow))))
   `(erc-current-nick-face ((t (:foreground ,tuntu/light-blue))))
   `(erc-notice-face       ((t (:foreground ,tuntu/green))))
   `(erc-input-face        ((t (:foreground "white"))))
   `(erc-timestamp-face    ((t (:foreground ,tuntu/darker-gray))))
   `(erc-prompt-face       ((t (:foreground "#191919" :background ,tuntu/purple))))
   ...
   `(undo-tree-visualizer-register-face      ((t (:foreground ,tuntu/yellow :background nil))))
   `(undo-tree-visualizer-current-face       ((t (:foreground ,tuntu/red :background nil))))
   `(undo-tree-visualizer-unmodified-face    ((t (:foreground ,tuntu/purple :background nil))))

   `(show-paren-match    ((t (:foreground nil :background ,tuntu/dark-gray))))
   `(show-paren-mismatch ((t (:inherit error))))

   `(error ((t (:foreground "red"))))

   `(ido-only-match        ((t (:foreground ,tuntu/green))))
   `(ido-first-match       ((t (:foreground ,tuntu/blue))))
   `(ido-incomplete-regexp ((t (:foreground ,tuntu/red))))
   `(ido-subdir            ((t (:foreground ,tuntu/yellow))))

   `(flx-highlight-face ((t (:foreground ,tuntu/lighter-blue :background nil :underline nil :bold t))))

   `(js2-external-variable        ((t (:foreground ,tuntu/orange :background nil))))
   `(js2-function-param           ((t (:foreground ,tuntu/dark-green :background nil))))
   `(js2-instance-member          ((t (:foreground ,tuntu/purple :background nil))))
   `(js2-jsdoc-html-tag-delimiter ((t (:foreground ,tuntu/dark-gray :background nil))))
   `(js2-jsdoc-html-tag-name      ((t (:foreground ,tuntu/darkest-gray :background nil))))
   `(js2-jsdoc-tag                ((t (:foreground ,tuntu/dark-red :background nil))))
   `(js2-jsdoc-type               ((t (:foreground ,tuntu/red :background nil))))
   `(js2-jsdoc-value              ((t (:foreground ,tuntu/tan :background nil))))
   `(js2-private-function-call    ((t (:foreground ,tuntu/dark-green :background nil))))
   `(js2-private-member           ((t (:foreground ,tuntu/dark-tan :background nil))))
   `(js2-warning                  ((t (:foreground nil :background nil :underline ,tuntu/orange))))
   ...
   `(web-mode-constant-face                  ((t (:foreground ,tuntu/purple :background nil))))
   `(web-mode-css-at-rule-face               ((t (:foreground ,tuntu/purple :background nil))))
   `(web-mode-css-color-face                 ((t (:foreground ,tuntu/light-blue :background nil))))
   `(web-mode-css-comment-face               ((t (:inherit font-lock-comment-face))))
   `(web-mode-css-function-face              ((t (:foreground ,tuntu/light-blue :background nil))))
   `(web-mode-css-priority-face              ((t (:foreground ,tuntu/light-blue :background nil))))
   `(web-mode-css-property-name-face         ((t (:inherit font-lock-variable-name-face))))
   `(web-mode-css-pseudo-class-face          ((t (:foreground ,tuntu/light-blue :background nil))))
   `(web-mode-css-selector-face              ((t (:foreground ,tuntu/blue :background nil))))
   `(web-mode-css-string-face                ((t (:foreground ,tuntu/tan :background nil))))
   ...
   `(web-mode-html-attr-name-face            ((t (:inherit font-lock-keyword-face :slant italic))))
   `(web-mode-html-attr-value-face           ((t (:inherit font-lock-string-face :slant italic))))
   `(web-mode-html-attr-equal-face           ((t (:inherit default :slant italic))))
   ...
   `(helm-M-x-key              ((t (:foreground ,tuntu/orange :underline nil))))
   `(helm-action               ((t ())))
   ...
   `(helm-buffer-size          ((t ())))
   `(helm-candidate-number     ((t (:foreground ,tuntu/green :background ,tuntu/darker-gray))))
   `(helm-ff-directory         ((t (:foreground ,tuntu/blue))))
   `(helm-ff-executable        ((t (:foreground ,tuntu/green))))
   `(helm-ff-file              ((t (:inherit default))))
   `(helm-ff-invalid-symlink   ((t ())))
   `(helm-ff-prefix            ((t (:foreground ,tuntu/red))))
   `(helm-ff-symlink           ((t ())))
   ...
   `(helm-grep-match           ((t ())))
   `(helm-grep-running         ((t ())))
   `(helm-header               ((t (:foreground ,tuntu/bg :background ,tuntu/fg))))
   `(helm-helper               ((t ())))
   `(helm-history-deleted      ((t ())))
   `(helm-history-remote       ((t ())))
   `(helm-lisp-completion-info ((t ())))
   `(helm-lisp-show-completion ((t ())))
   `(helm-match                ((t (:foreground ,tuntu/blue :background ,tuntu/darkest-gray))))
   `(helm-moccur-buffer        ((t ())))
   `(helm-selection            ((t (:foreground ,tuntu/yellow :background ,tuntu/region :bold t))))
   `(helm-selection-line       ((t ())))
   `(helm-separator            ((t ())))
   `(helm-source-header        ((t (:foreground ,tuntu/darkest-gray :background ,tuntu/blue))))
   `(helm-visible-mark         ((t ())))
   ...
   `(jabber-chat-prompt-foreign    ((t (:foreground ,tuntu/green  :background nil :underline nil :bold t))))
   `(jabber-chat-prompt-local      ((t (:foreground ,tuntu/light-blue   :background nil :underline nil :bold t))))
   `(jabber-chat-prompt-system     ((t (:foreground ,tuntu/yellow :background nil :underline nil :bold t))))
   `(jabber-chat-text-foreign      ((t (:inherit default :background nil))))
   `(jabber-chat-text-local        ((t (:inherit default :bold t))))
   `(jabber-rare-time-face         ((t (:foreground ,tuntu/purple :background nil :underline t))))
   `(jabber-roster-user-away       ((t (:inherit font-lock-string-face))))
   `(jabber-roster-user-chatty     ((t (:foreground ,tuntu/orange :background nil :bold t))))
   ...
   `(rainbow-delimiters-depth-1-face   ((t (:foreground ,tuntu/rb0 :background nil))))
   `(rainbow-delimiters-depth-2-face   ((t (:foreground ,tuntu/rb1 :background nil))))
   `(rainbow-delimiters-depth-3-face   ((t (:foreground ,tuntu/rb2 :background nil))))
   `(rainbow-delimiters-depth-4-face   ((t (:foreground ,tuntu/rb3 :background nil))))
   `(rainbow-delimiters-depth-5-face   ((t (:foreground ,tuntu/rb4 :background nil))))
   `(rainbow-delimiters-depth-6-face   ((t (:foreground ,tuntu/rb5 :background nil))))
   `(rainbow-delimiters-depth-7-face   ((t (:foreground ,tuntu/rb0 :background nil))))
   `(rainbow-delimiters-depth-8-face   ((t (:foreground ,tuntu/rb1 :background nil))))
   `(rainbow-delimiters-depth-9-face   ((t (:foreground ,tuntu/rb2 :background nil))))
   `(rainbow-delimiters-unmatched-face ((t (:inherit error))))

   `(ac-candidate-face           ((t (:foreground "black" :background ,tuntu/fg))))
   `(ac-selection-face           ((t (:foreground ,tuntu/fg :background ,tuntu/blue))))
   ...
   `(company-tooltip                  ((t (:foreground                ,tuntu/bg :background ,tuntu/fg))))
   `(company-tooltip-common           ((t (:foreground ,tuntu/blue :background ,tuntu/fg))))
   `(company-tooltip-common-selection ((t (:foreground ,tuntu/bg :background ,tuntu/blue))))
   `(company-tooltip-mouse            ((t (:foreground nil :background ,tuntu/light-blue))))
   `(company-tooltip-selection        ((t (:foreground       ,tuntu/fg :background ,tuntu/blue))))

   `(w3m-anchor                       ((t (:foreground "cyan" :background nil))))
   `(w3m-arrived-anchor               ((t (:foreground "LightSkyBlue" :background nil))))
   `(w3m-bold                         ((t (:foreground ,tuntu/blue :background nil :bold t))))
   ...
   `(w3m-italic                       ((t (:foreground ,tuntu/orange :background nil :underline t))))
   ...
   `(w3m-underline                    ((t (:foreground ,tuntu/green :background nil :underline t))))
   ...
   `(ediff-fine-diff-A        ((t (:foreground ,tuntu/fg :background "#694949"))))
   `(ediff-fine-diff-B        ((t (:foreground ,tuntu/fg :background "#496949"))))
   `(ediff-fine-diff-C        ((t (:foreground ,tuntu/fg :background "#696949"))))
   ...
   `(Man-overstrike ((t (:foreground ,tuntu/blue))))
   `(Man-underline  ((t (:foreground ,tuntu/yellow))))
   ...
   `(org-done                      ((t (:foreground ,tuntu/green :background nil))))
   `(org-todo                      ((t (:foreground ,tuntu/red :background nil))))
   ...
   `(org-hide                      ((t (:foreground ,tuntu/bg :background nil))))
   ...
   `(message-header-cc         ((t (:foreground ,tuntu/light-blue :background nil :bold t))))
   `(message-header-name       ((t (:foreground ,tuntu/orange :background nil))))
   `(message-header-newsgroups ((t (:foreground ,tuntu/dark-tan :background nil :bold t))))
   `(message-header-other      ((t (:foreground ,tuntu/blue :background nil))))
   `(message-header-subject    ((t (:foreground ,tuntu/tan :background nil))))
   `(message-header-to         ((t (:foreground ,tuntu/yellow :background nil :bold t))))
   `(message-header-xheader    ((t (:foreground ,tuntu/purple :background nil))))
   `(message-mml               ((t (:foreground ,tuntu/dark-tan :background nil))))
   ...
   `(gnus-group-mail-1                      ((t (:foreground ,tuntu/blue :background nil :bold t))))
   `(gnus-group-mail-1-empty                ((t (:foreground ,tuntu/blue :background nil))))
   `(gnus-group-mail-2                      ((t (:foreground ,tuntu/lighter-blue :background nil :bold t))))
   `(gnus-group-mail-2-empty                ((t (:foreground ,tuntu/lighter-blue :background nil))))
   `(gnus-group-mail-3                      ((t (:foreground ,tuntu/light-blue :background nil :bold t))))
   `(gnus-group-mail-3-empty                ((t (:foreground ,tuntu/light-blue :background nil))))
   `(gnus-group-mail-low                    ((t (:foreground ,tuntu/yellow :background nil :bold t))))
   `(gnus-group-mail-low-empty              ((t (:foreground ,tuntu/yellow :background nil))))
   ...
   `(gnus-summary-normal-read               ((t (:foreground ,tuntu/green :background nil))))
   `(gnus-summary-normal-ticked             ((t (:foreground ,tuntu/orange :background nil))))
   `(gnus-summary-normal-undownloaded       ((t (:foreground ,tuntu/dark-gray :background nil))))
   `(gnus-summary-normal-unread             ((t (:foreground ,tuntu/light-blue :background nil))))
   ...
   `(whitespace-empty                         ((t (:foreground ,tuntu/gray :background "gray10"))))
   `(whitespace-hspace                        ((t (:foreground ,tuntu/gray :background "grey11"))))
   `(whitespace-indentation                   ((t (:foreground ,tuntu/gray :background "gray12"))))
   `(whitespace-line                          ((t (:foreground ,tuntu/purple :background nil))))
   `(whitespace-newline                       ((t (:foreground ,tuntu/gray :background nil))))
   `(whitespace-space                         ((t (:foreground ,tuntu/gray :background nil))))
   `(whitespace-space-after-tab               ((t (:foreground ,tuntu/gray :background "gray13"))))
   `(whitespace-space-before-tab              ((t (:foreground ,tuntu/gray :background "gray14"))))
   `(whitespace-tab                           ((t (:foreground ,tuntu/gray :background "grey15"))))
   `(whitespace-trailing                      ((t (:foreground ,tuntu/rb3 :background ,tuntu/bg :bold t))))

   `(magit-branch                               ((t (:foreground ,tuntu/orange :background nil))))
   `(magit-cherry-equivalent                    ((t (:foreground "cyan" :background nil))))
   `(magit-cherry-unmatched                     ((t (:foreground "magenta" :background nil))))
   `(magit-diff-add                             ((t (:foreground nil :background ,tuntu/dark-green))))
   `(magit-diff-del                             ((t (:foreground nil :background ,tuntu/dark-red))))
   `(magit-diff-file-header                     ((t (:foreground ,tuntu/bg :background ,tuntu/blue :bold t))))
   `(magit-diff-hunk-header                     ((t (:foreground ,tuntu/bg :background ,tuntu/blue))))
   `(magit-diff-merge-current                   ((t (:foreground ,tuntu/orange :background nil))))
   `(magit-diff-merge-diff3-separator           ((t (:foreground ,tuntu/orange :background nil))))
   `(magit-diff-merge-proposed                  ((t (:foreground ,tuntu/orange :background nil))))
   `(magit-diff-merge-separator                 ((t (:foreground ,tuntu/orange :background nil))))
   `(magit-diff-none                            ((t (:foreground ,tuntu/fg :background ,tuntu/darker-gray))))
   `(magit-header                               ((t (:foreground ,tuntu/blue :background nil))))
   `(magit-item-highlight                       ((t (:foreground nil :background ,tuntu/darker-gray))))
   `(magit-item-mark                            ((t (:foreground nil :background "darkolivegreen"))))
   `(magit-key-mode-args-face                   ((t (:foreground "black" :background "yellow3"))))
   `(magit-key-mode-button-face                 ((t (:foreground ,tuntu/light-blue :background nil))))
   `(magit-key-mode-header-face                 ((t (:foreground ,tuntu/blue :background nil))))
   `(magit-key-mode-switch-face                 ((t (:foreground "red" :background nil :bold t))))
   `(magit-log-author                           ((t (:foreground ,tuntu/red :background nil))))
   `(magit-log-author-date-cutoff               ((t (:foreground ,tuntu/red :background nil :bold t))))
   ...
   `(magit-log-sha1                             ((t (:foreground ,tuntu/purple :background nil))))
   `(magit-section-title                        ((t (:foreground ,tuntu/blue :background nil))))
   `(magit-tag                                  ((t (:foreground ,tuntu/blue :background nil))))
   `(magit-valid-signature                      ((t (:foreground "PaleTurquoise" :background nil :bold t))))
   `(magit-whitespace-warning-face              ((t (:foreground ,tuntu/bg :background "white" :bold t))))

   `(git-gutter:added         ((t (:foreground ,tuntu/green :background nil :bold t))))
   `(git-gutter:deleted       ((t (:foreground ,tuntu/red :background nil :bold t))))
   `(git-gutter:modified      ((t (:foreground ,tuntu/purple :background nil :bold t))))
   `(git-gutter:separator     ((t (:foreground ,tuntu/orange :background nil :bold t))))
   `(git-gutter:unchanged     ((t (:foreground ,tuntu/yellow :background nil))))
